...
\begin{frame}[fragile]{What is Multi-stage Programming}
    ...
    \note{
        ...
        as run-time specialization and DSLs, for example TODO.
    }
\end{frame}
...
\begin{frame}[fragile]{Types and Kinds of \LMD}
    Append dependent function types to types of \LTP.
    \begin{block}{Types}
        \begin{tabbing}
...
\begin{frame}[fragile]{CSP in Types}
    ...
    \begin{exampleblock}{}
        \begin{center}
            \( \underbrace{\Pi n:\text{int}. \TW (\overbrace{\text{vec}\ \%n}^{\text{stage }1})}_{\text{stage }0} \)
        \end{center}
    \end{exampleblock}
\end{frame}
