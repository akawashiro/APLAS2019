...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Otherwise
            ...
            Use "Generized Inversion Lemma for $\TW$ type" to $\G \V M : \TW_\alpha \tau @ A$, we get $\MD{2}$ from $\MD{1}$.
        
            $\MD{2}$ = \infer[\TTBL]
            {\G \V \TBL_\alpha \TB_\alpha M :\tau @ A\alpha}
            {\ID{\G \V \TB_\alpha M : \TW_\alpha \tau @ A}}
