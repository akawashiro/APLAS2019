...
\begin{center}
	...
	\infrule{\G\V M:\forall\alpha.\tau@A}{\G\V M\ \varepsilon:\tau[\alpha \mapsto \varepsilon]@A}{\textsc{T-Ins}} \andalso
...
\begin{center}
	...
	\infrule{\G\V M \E N:\forall\alpha.\tau@A}{\G\V M\ \varepsilon \E N\ \varepsilon : \tau[\alpha \mapsto \varepsilon]@A}{\QIns}\andalso
	...
	\infrule{\G\V (\Lambda\alpha.M) : \forall\alpha.\tau@A}{\G\V (\Lambda\alpha.M)\ \varepsilon \E M[\alpha \mapsto \varepsilon] : \tau[\alpha \mapsto \varepsilon]@A}{\QLambda} \\[2mm]
...
\begin{thm}[Stage Substituition Lemma for Variables of Terms, Types or Kinds and Their Equivalence]
	\begin{flalign*}
		\text{If\ } \G \V M:\tau@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V M[\beta \mapsto \varepsilon]:\tau[\beta \mapsto \varepsilon]@A[\beta \mapsto \varepsilon].&\\
		\text{If\ } \G \V \tau::K@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V \tau[\beta \mapsto \varepsilon]::K[\beta \mapsto \varepsilon]@A[\beta \mapsto \varepsilon].&\\
		\text{If\ } \G \V K\iskind@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V K[\beta \mapsto \varepsilon] \iskind@A[\beta \mapsto \varepsilon].&\\
		\text{If\ } \G \V M\E N : \tau@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V M[\beta \mapsto \varepsilon]\E N[\beta \mapsto \varepsilon] : \tau[\beta \mapsto \varepsilon] @A[\beta \mapsto \varepsilon].&\\
		\text{If\ } \G \V \tau\E \sigma : K@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V \tau[\beta \mapsto \varepsilon]\E \sigma[\beta \mapsto \varepsilon] : K[\beta \mapsto \varepsilon]@A[\beta \mapsto \varepsilon].&\\
		\text{If\ } \G \V K\E J@A
		&\text{\ then\ } \G[\beta \mapsto \varepsilon]\V K[\beta \mapsto \varepsilon]\E J[\beta \mapsto \varepsilon]@A[\beta \mapsto \varepsilon].&
	\end{flalign*}
\end{thm}

\begin{itemize}

	\newcommand{\SB}{[\beta \mapsto \varepsilon]}
	\newcommand{\GG}{\G\SB}
...
\begin{itemize}
	...
	\item \TIns
	      ...
	      \begin{itemize}
		      \item $\Lambda\alpha.M\ \varepsilon \R M[\alpha \mapsto \varepsilon]$

		            The type derivation tree looks like $\mathcal{D}_1$.

		            $\mathcal{D}_1$ = \infer[\TIns]
		            {\G \V \Lambda\alpha.M\ \varepsilon : \tau[\alpha \mapsto \varepsilon] @ A}
		            ...
		            get $\G[\alpha \mapsto \varepsilon] \V M[\alpha \mapsto \varepsilon] : \tau[\alpha \mapsto \varepsilon] @ A[\alpha \mapsto \varepsilon]$.

		            Because $\alpha \notin \FTV(\G) \cup \FV(A)$, $\G[\alpha \mapsto \varepsilon] = \G$ and $A[\alpha \mapsto \varepsilon] = A$.

		            So, we can rewrite $\G[\alpha \mapsto \varepsilon] \V M[\alpha \mapsto \varepsilon] : \tau[\alpha \mapsto \varepsilon] @ A[\alpha \mapsto \varepsilon]$ to
		            $\G \V M[\alpha \mapsto \varepsilon] : \tau[\alpha \mapsto \varepsilon] @ A$.
		      \item $M\ \varepsilon \R M'\ \varepsilon$
...
\begin{itemize}
	...
	\item \TIns
	      ...
	      $\MD{1}$ = \infer[\TIns]
	      {\G \V M\ \varepsilon : \tau[\alpha \mapsto \varepsilon] @ A}
		      ...
		      \item $ M \in V^A $
		            ...
		            \begin{itemize}
			            \item $A=\varepsilon$
			                  ...
			                  Then, $\Lambda\alpha.v^\varepsilon\ \varepsilon \longrightarrow_\Lambda v^\varepsilon[x\mapsto \varepsilon]$.

			            \item Otherwise

			                  $v^A \varepsilon \in V^A$.
		            \end{itemize}

		      \item $\exists M'$ such that $M \longrightarrow M'$

		            $M\ \varepsilon \longrightarrow M'\ \varepsilon$
	      \end{itemize}
		      ...
		      \item $ A = \varepsilon$
		            ...
		            \begin{itemize}
			            ...
			            \item $\exists ! B, E^\varepsilon_B, R^B$ such that ($B = \varepsilon$ or $B = \beta$) and $M = E^\varepsilon_B[R^B]$
			                  ...
			                  Because $ E^\varepsilon_B[R^B] \neq \Lambda\alpha.v^\varepsilon$, we can decompose $E^\varepsilon_B[R^B]\ \varepsilon$ uniquely.
		            \end{itemize}
		      ...
		      \item $ A \neq \varepsilon $
		            ...
		            \begin{itemize}
			            \item $ M \in V^A$
			                  ...
			                  It is clear that $v^A\ \varepsilon \in V^A$.

			            \item $\exists ! B, E^A_B, R^B$ such that ($B = \varepsilon$ or $B = \beta$) and $M = E^A_B[R^B]$

			                  Because we cannot $\Lambda$ reduction at stage $A$, we can decompose $E^A_B[R^B]\ \varepsilon$ uniquely.
		            \end{itemize}
