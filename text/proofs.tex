...
\begin{proof}
	...
	We show only representative cases.
        ...
        \begin{rneqncase}{\QTAbs}{
          ...
          \end{align*}
          from which \( \D\V \rho \E \pi :: * @ A \) follows. \qed
        \end{rneqncase}
\end{proof}
...
\begin{itemize}
	...
	\item \textit{Case} $(\lambda x:\tau.M)\ N \R M[x \mapsto N]$\\
		...
		%   By applying Inversion Lemma for Application to $(\lambda x:\tau.M)\ N$,
		%   we get $\G, x:\sigma \V M:\tau@A$ and $\G \V N:\sigma@A$.
	% \item Otherwise\\
	    %   We can prove by the induction hypothesis.
\end{itemize}
\end{proof}
