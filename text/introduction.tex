...
studied in the literature~\cite{8384206,taha2007gentle}  \AI{We should list
...
types.  Our technical contribution are summarized as follows:
\begin{itemize}
...
work.  For reference, we give the full definition of \LMD \AI{and
