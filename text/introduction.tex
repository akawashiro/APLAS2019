...
including under $\lambda$-abstraction and quotation, and staged reduction, a
small-step call-by-value operational semantics that is closer to the intended
multi-stage implementation. \AK{This sentence looks too long as an item.}
...
discussed by Brady and Hammond~\cite{brady2006dependently} \AK{Should we
include Meta-D~\cite{pasalic2002tagless}?}, to our knowledge, our work is a
first formal calculus of dependently typed multi-stage programming.  
