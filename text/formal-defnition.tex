...
them. \AK{I strenghened this example by adding concrete situation. Do we need
...
with respect to the size of vectors. The function vadd (with an auxiliary
function vadd$_1$) below implements a code generator in a hypothetical
language based on \LTP. This language provides definitions by \textbf{let},
