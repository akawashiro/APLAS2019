...
reduced. Terms at non-$\varepsilon$ stages are not reduced as long as they do
not contain a term such as \(\TBL_\alpha \TB_\alpha M\). A few examples of
evaluation context are shown below:
\begin{align*}
