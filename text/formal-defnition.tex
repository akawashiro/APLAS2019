...
Note that constants and type-level constants are not associated with stages;
...
\begin{definition}[Typing, Kinding, Well-formed Kinding, Term Equivalence, Type Equivalence, Kind Equivalence]
    ...
    are the least relation closed under the rules in Figure~\ref{fig:typing-rules}.  \AI{There are more rules!  Some of them are not even in the paper.}
\end{definition}
...
\AI{I think well-formed signatures and type environments cannot be defined independently.}
...
In order to define Staged Reduction, we define redex and evaluation context.
