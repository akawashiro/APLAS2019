...
the code in order to prevent free variable evaluation. \AK{Is here
appropriate? Although this paper using the concept of dependent types, the
purpose is avoid open code problem. Therefore, I cite this paper here.}
...
combination with dependent types has been little studied. \AK{little?} Brady
...
environment classifiers. In Forgarty, Pasalic, Siek and
Taha~\cite{fogarty2007concoqtion}, they extended the type system of MetaOCaml
with indexed types. With this extension, types can be indexed with a Coq term.
...
it cannot manipulate open code which ours can deal with. \AK{Is the place of
