...
\begin{document}
%
\title{Dependently Typed Multi-Stage Calculus\thanks{Supported by organization x.}}
%
...
The main technical points of this paper are how to deal with Cross Stage Persistence of multi-stage calculuses in a dependent type system.
CSP is a function of a multi-stage calculus which allows using a value in quoted code.
...
\begin{itemize}
   ...
   \item \red{Dependent types in practical programming}\cite{xi1999dependent}
\end{itemize}
