...
\LMD is developed on the basis of \LTP but there is no type equivalence rules in \LTP.
...
% 通常のルール
The rules \TVar , \TAbs, and \TApp\ are almost same as those in simply typed lambda calculus if you ignore stage annotations.
...
the following derivation tree in Figure \ref{fig:tconst-derivation-tree} is admissible.
