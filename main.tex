...
The rules \TVar , \TAbs, and \TApp\ are almost same as those in simply typed lambda calculus 
...
Another is defining type equivalence directly by combination of type equivalence rules.
