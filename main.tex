...
For example, $\TB_\alpha 1$ is a fragment of code which becomes $1$ after run it once and
$\TB_\alpha \TB_\beta 1$ becomes $1$ after run it twice.
...
\begin{theorem}[Inversion Lemma for $\Pi$ type]
