...
is impremented with loop in many cases.
...
Although unrolled \verb|add| function is optimzied, we cannot use it for different vector length.
For example, when you optimize for the length of 5, you shoudn't use it for vectors of 3 lengths.
Otherwise, we will get Segmentation Fault error.
...
so that the type sysytem can guarantee optimzied functions are used properly.

\subsection{Organization of the Paper}

The organization of this paper is following.
Section 2 gives an informal overview \LMD.
Section 3 defines the syntax, type system, full reduction, evaluation contexts of \LMD.
Section 4 shows properties of \LMD including Unique Decomposition.
